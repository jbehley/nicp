...
class HomogeneousVector4f : public Eigen::Vector4f {
 public:
  ...
  /**
     *  This methods implements the operator equal between an Homogeneous4fVector and an other Homogeneous4fVector object.
     */
  template <int otherWCoordinate>
  inline HomogeneousVector4f &operator=(const HomogeneousVector4f<otherWCoordinate> &other) {
