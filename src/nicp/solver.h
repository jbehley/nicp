...
namespace nicp {
 ...
 /**
  ...
  public:
    ...
    typedef _SigmaPoint<Vector6f> SigmaPoint;
    ...
    void setReferenceModel(const map_core::Cloud* m);
    inline const map_core::Cloud* referenceModel() const { return _reference;}


    //! sets/gets the model that moves
    void setCurrentModel(const map_core::Cloud* m);
    inline const map_core::Cloud* currentModel() const {return _current;}
    ...
    Matrix6f  remapInformationMatrix(const Eigen::Isometry3f& T);
  ...
  protected:
    ...
    const map_core::Cloud* _reference, *_current;
