...
namespace nicp {
  ...
  public:
    ...
    inline const map_core::Cloud* currentModel() const { return _solver.currentModel();}

    inline const map_core::Cloud* referenceModel() const { return _solver.referenceModel();}
    
    virtual void setCurrentModel( const map_core::Cloud* m);
    virtual void setReferenceModel( const map_core::Cloud* m);
  ...
  protected:
    ...
    Solver _solver;
    map_core::Cloud _compressed_reference;
