...
namespace nicp {
  ...
  public:
    ...
    virtual void project(FloatImage& zbuffer, 
		 ...
		 const map_core::Cloud& model) const;
    ...
    virtual bool supportsCameraInfo(map_core::BaseCameraInfo* _camera_info) const;

    virtual void setCameraInfo(map_core::BaseCameraInfo* _camera_info);

    virtual void initFromCameraInfo(map_core::BaseCameraInfo* _camera_info);
