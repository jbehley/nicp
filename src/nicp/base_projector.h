...
namespace nicp {
  ...
  public:
    ...
    virtual void project(FloatImage& zbuffer, 
			 ...
			 const map_core::Cloud& model) const = 0;
    ...
    inline map_core::BaseCameraInfo* cameraInfo() { return _camera_info;}

    virtual void setCameraInfo(map_core::BaseCameraInfo* _camera_info);

    virtual bool supportsCameraInfo(map_core::BaseCameraInfo* _camera_info) const = 0;
    ...
    virtual void unproject(map_core::Cloud& cloud, const RawDepthImage& depth_image, const RGBImage& rgb_image = RGBImage());
  ...
  protected:
    ...
    void computeNormals(map_core::Cloud& cloud, const RawDepthImage& depth_image);
    ...
    map_core::BaseCameraInfo* _camera_info;
    int _nb_window;
    int _cp_window;
