...
#include "nicp/projective_correspondence_finder.h"
#include "nicp/depth_utils.h"
#include "nicp/solver.h"
#include "nicp/base_aligner.h"
#include "map_core/base_camera_info.h"
#include "nicp/camera_info_manager.h"
...
namespace map_tracker {
  ...
  public:
    ...
    Tracker(nicp::BaseAligner* a=0, nicp::BaseProjector*p=0);
    ...
    //! The pose offset is computed by the system in the reference frame of the base. This allows to handle multiple cams
    //! @param topic: the topic of the image
    virtual void processSphericalFrame(const RawDepthImage& depth, 
		      const RGBImage& rgb, 
    ...
    nicp::BaseProjector& projector() { return *_projector;}

    //! access to the internal aligner object
    nicp::BaseAligner& aligner() { return *_aligner;}
    ...
    inline nicp::CameraInfoManager& cameras() { return _cameras; }
    ...
    inline map_core::Cloud* currentModel() { return _current;}
    //! access to the reference cloud (the local map cloud)
    inline map_core::Cloud* referenceModel() { return _reference;}
    inline void setReferenceModel(const map_core::Cloud& reference_model) { _reference=new map_core::Cloud(reference_model); }
    ...
    inline RawDepthImage& lastRawDepth() {return _last_raw_depth;}
    ...
    inline map_core::BaseCameraInfo* lastCamera() {return _last_camera;}
    ...
    UnsignedCharImage changesImage() const {return _changes_image;}
  ...
  protected:
    ...
    int _frame_skip;
    int _frame_count;
    nicp::CameraInfoManager _cameras;
    nicp::BaseProjector* _projector;
    ...
    FloatImage _changes_reference_depth, _changes_current_depth;
    IntImage _changes_reference_indices, _changes_current_indices;
    UnsignedCharImage _changes_mask;
    void computeChanges();
    ...
    RGBImage _last_raw_rgb;

    //Eigen::Matrix3f _last_K;
    int _last_seq;
    float _last_depth_scale;
    map_core::BaseCameraInfo* _last_camera;
    ...
    UnsignedCharImage _changes_image;
