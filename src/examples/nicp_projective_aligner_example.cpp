...
const char* banner[] = {
  "nicp_projective_aligner_example: example on how to register two point clouds using a pinhole projection based aligner",
  "usage:",
  " nicp_projective_aligner_example <model1.dat> <model2.dat> <output.dat>",
  0
};
