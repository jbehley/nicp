...
#include "globals/message_reader.h"
#include "globals/pinhole_image_message.h"
#include "globals/static_transform_tree.h"
...
const char* banner[]= {
  "nicp_local_mapper_gui_app: offline local mapper working on dump files written with nicp_message_dumper_node",
  "usage:",
  " nicp_local_mapper_gui_app [options] <dump filename>",
  " where: ",
